...
CORNER_LIST corner_list; // do not use stack
...
corner_draw(in,x_size,drawing_mode)
  uchar *in;
...
susan_corners(in,r,bp,max_no,x_size,y_size)
  uchar       *in, *bp;
  int         *r, max_no, x_size, y_size;
{
int   n,x,y,sq,xx,yy,
...
susan_corners_quick(in,r,bp,max_no,x_size,y_size)
  uchar       *in, *bp;
  int         *r, max_no, x_size, y_size;
{
int   n,x,y,i,j;
